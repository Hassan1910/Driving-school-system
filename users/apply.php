                                            ...
                                            <div class="row form-group">
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="licno" placeholder="Licence Number" maxlength="15" class="form-control">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="city" class="form-control-label">Upload Licence</label>
                                                        <input type="file" name="licpic" class="form-control">
                                                    </div>
