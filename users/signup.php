...
if(isset($_POST['submit'])) {
    ...
    if($result > 0) {
        ...
        $query = mysqli_query($con, "INSERT INTO tblregusers(FirstName, LastName, MobileNumber, Email, Password, Status) VALUES ('$fname', '$lname', '$contno', '$email', '$password', 'pending')");
        if ($query) {
            echo '<script>alert("You have successfully registered. Please wait for admin approval.")</script>';
        } else {
